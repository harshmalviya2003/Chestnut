...
import { Star, Zap, Home, BarChart, DollarSign } from "lucide-react"
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 mb-4 md:mb-6 px-3 py-1.5 md:px-4 md:py-2 bg-white rounded-full shadow-sm border border-gray-200 hover:border-[#0022DF] transition-colors">
              ...
              <span className="text-sm md:text-base font-medium text-gray-700">AI-Powered Mortgage Solutions</span>
              <Home className="h-4 md:h-5 w-4 md:w-5 text-[#0022DF] ml-1 md:ml-2" />
            </div>
            ...
            <p className="text-gray-700 text-lg sm:text-xl md:text-2xl mb-6 md:mb-8 max-w-lg leading-relaxed">
              Secure your dream home with our AI-driven platform, offering <span className="font-semibold text-[#0022DF]">0.5% lower rates</span> and 
              <span className="font-semibold"> instant quotes</span> from over 100 lenders.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-2 md:gap-3">
              ...
              <div className="inline-flex items-center px-2.5 py-1 md:px-3 md:py-1.5 bg-white rounded-full text-sm md:text-base font-medium text-black shadow-sm border border-gray-200 hover:border-[#0022DF] transition-colors">
                <DollarSign className="h-3.5 w-3.5 md:h-4 md:w-4 text-[#0022DF] mr-1 md:mr-1.5" />
                Competitive Rates
              </div>
              ...
              <div className="flex items-center bg-white px-2.5 py-1 md:px-3 md:py-1.5 rounded-full shadow-sm border border-gray-200">
                <div className="flex -space-x-1.5 md:-space-x-2 mr-1.5 md:mr-2">
                  <div className="w-5 h-5 md:w-6 md:h-6 rounded-full bg-[#0022DF]/10 border-2 border-white flex items-center justify-center text-[10px] md:text-xs font-bold text-[#0022DF]">C</div>
                  <div className="w-5 h-5 md:w-6 md:h-6 rounded-full bg-[#0022DF]/10 border-2 border-white flex items-center justify-center text-[10px] md:text-xs font-bold text-[#0022DF]">M</div>
                </div>
                <div className="flex items-center">
                  <Star className="h-3 w-3 md:h-3.5 md:w-3.5 text-[#0022DF] fill-[#0022DF] mr-0.5 md:mr-1" />
                  <span className="text-base md:text-lg font-medium text-gray-800">5.0</span>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md">
              ...
              >
                <Home className="h-5 md:h-8 w-5 md:w-8 text-[#0022DF]" />
                <span className="absolute -bottom-1.5 md:-bottom-2 bg-white px-1 py-0.5 md:px-1.5 md:py-0.5 rounded text-[10px] md:text-xs font-bold text-[#0022DF] border border-gray-200">Mortgage AI</span>
              </motion.div>
              ...
              >
                <div className="text-center">
                  <div className="text-lg md:text-xl font-bold text-[#0022DF]">$85B+</div>
                  <div className="text-[8px] md:text-[10px] text-gray-600">Mortgages Powered</div>
                </div>
              </motion.div>
              ...
              <div className="relative rounded-xl md:rounded-2xl overflow-hidden shadow-lg md:shadow-xl border-4 md:border-[6px] border-white transform rotate-1 hover:rotate-0 transition-transform duration-300">
                ...
                <div className="absolute bottom-3 left-3 right-3 md:bottom-4 md:left-4 md:right-4 flex justify-between items-center">
                  <div className="bg-black/70 text-white text-[10px] md:text-xs px-1.5 py-0.5 md:px-2 md:py-1 rounded">Rate Comparison</div>
